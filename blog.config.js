...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DoRight', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '没有什么能够阻挡，我对自由的向往', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://doright.life', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活、认知、投资', // 网站关键词 英文逗号隔开
  ...
  POSTS_PER_PAGE: 30, // post counts per page
